...
func (s *DictionaryDetailRouter) InitSysDictionaryDetailRouter(Router *gin.RouterGroup, PrivateGroupFrontUser *gin.RouterGroup) {
	...
	dictionaryDetailFrontRouter := PrivateGroupFrontUser.Group("sysDictionaryDetail")
	{
	...
	{
		dictionaryDetailFrontRouter.GET("front/list", dictionaryDetailApi.GetSysDictionaryDetailList)
	}
}
